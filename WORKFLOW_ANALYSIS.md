...
* When the code is pushed to the main branch it allows workflow to run.
...
* To deploy the environment to GitHub Pages is the purpose for the environment configuration.
